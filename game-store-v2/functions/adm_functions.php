        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSite">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="show_clients.php">Customers</span></a>
                    </li>
    
                    <li class="nav-item active">
                        <a class="nav-link" href="register_product.php">Products</span></a>
                    </li>
    
                    <li class="nav-item active">
                        <a class="nav-link" href="sales.php">Sales</span></a>
                    </li>
                </ul>
